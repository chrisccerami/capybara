...
module Capybara
  ...
  class << self
    ...
    attr_accessor :save_and_open_page_path, :first_default_waiting, :automatic_reload, :raise_server_errors, :server_errors
    ...
    # [first_default_waiting = Boolean]   Whether Node#first defaults to Capybara waiting behavior for at least 1 element to match (Default: false) 
    # === DSL Options
    #
...
Capybara.configure do |config|
  ...
  config.first_default_waiting = false
end
